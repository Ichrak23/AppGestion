<template>
  <ion-page>
    ...
    <ion-content>
        <br> 
    <div class="addfiletitle">
     &nbsp;&nbsp;&nbsp; AJOUTER UN FICHIER
    </div>
    <div class="inputclass">
        <img class="imageposition" src="../assets/uploadBlue.97f392e8.svg" />
        <br>
         <div class="addfiletitle2">
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;déposez un fichier ici pour l'ajouter au &nbsp;&nbsp;document ou 
      cliquez pour parcourir vos fichiers
    </div>
    <input id="file" type="file" accept="application/pdf,application/vnd.ms-excel"
     size="2" class="hidden-file-input"  @change="onChange">
    </div>
...
.inputclass{
     ...
     margin-left:50px;
     margin-top: 50px;
     /* background-image: url("../assets/uploadBlue.97f392e8.svg"); */
